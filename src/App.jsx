...
export default () => {
    ...
    return (
        <div className={cl.wrap}>
            <div className={cl.wrap1}>
                <div className={cl.indicator} style={{background: way === 1 ? "blue" : "black"}}
                     onClick={replace}></div>
                <div className={cl.wrapBoard}>
                    <Board cells={cells} way={way} setCells={setCells}/>
                </div>
            </div>
        </div>
    )
